...
// getting users name etc and checking validation creating user
router.post('/createuser', [
    ...
    if (!errors.isEmpty()) {
      return res.status(400).json({ success, errors: errors.array(),error:"lol" });
    }
    try {
...
//Route 3: get users details using post "/api/auth/getuser", login req
